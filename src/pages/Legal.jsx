...
const legalPages = {
  terms: {
    ...
    sections: [
      ...
      { heading: '2. Service Description', content: 'Toggle facilitates connections between clients seeking professional services and verified service providers across three verticals: Legal Services (e-discovery, contract lifecycle management, due diligence, form completion and compliance, dedicated legal resource centers), Finance Services (core financial operations, strategic financial operations, global payroll management, business operational call centers), and Technical Services (project management support, cost-estimation and budget control, claims and submissions processing, report writing). Toggle is a marketplace platform and does not itself provide legal, financial, or technical advice.' },
